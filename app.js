...
insBtn.addEventListener('click', function(e){
    ...
    setTimeout(()=>{
        insBox.style= "transform: translate(-50%, -50%) scale(1.2);"
        insBox.classList.add('show-element')
...
document.addEventListener('click', function(e){
    if(e.target === overlay || e.target === closeBtn){
        e.preventDefault
        insBox.style= "transform: translate(-50%, -50%) scale(0);"
        insBox.classList.remove('show-element')
        setTimeout(()=>{
